# Репозиторий проекта "Погнали!" в рамках стажировки студентки HTML Academy Неброевой Вероники

* Организатор: (https://t.me/s/ligaaagency/).
* Дизайн, макет: (https://htmlacademy.ru/).
* Правообладатель материалов: (https://htmlacademy.ru/).
